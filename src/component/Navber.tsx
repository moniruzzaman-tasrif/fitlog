    ...
    <div className="bg-[#0C0D10]">
      <div className="navbar  shadow-sm max-w-350 mx-auto">
        ...
        <div className="navbar-end flex gap-4">
          <Link href="/" className=" text-gray-300 flex gap-2">
            {" "}
            <span>Plan</span>
            <span className=" px-2 rounded-4xl flex justify-center items-center text-white bg-[#C2F800]">
              {" "}
              0
            </span>
          </Link>
          <Link href="/" className="text-gray-500 flex gap-2  ">
            Saved
            <span className="border px-2 rounded-4xl">0</span>
          </Link>
        </div>
      </div>
    </div>
